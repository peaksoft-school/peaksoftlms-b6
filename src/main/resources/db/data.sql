...
insert into courses_lessons(course_id, lessons_id)
values (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
...
insert into contents(id, content_format, content_name, content_value)
values (1, 'VIDEO', 'video link', 'aws');
...
insert into results(id, date_of_pass, percent, student_id)
values (1, '2022/11/10', 100, 1);

insert into tests_results(test_id, results_id)
values (1, 1);

insert into tasks_contents(task_id, contents_id)
values (1, 1);